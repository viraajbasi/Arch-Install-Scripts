...
pacman -S --needed --noconfirm kitty firefox thunderbird ark mpv notepadqq dolphin dolphin-plugins gwenview libreoffice discord gimp gparted btop neofetch firewalld youtube-dl blender inkscape
