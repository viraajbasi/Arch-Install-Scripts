...
# pacman -S --needed --noconfirm alacritty firefox thunderbird ark p7zip mpv dolphin dolphin-plugins gwenview kate libreoffice discord gimp gparted steam lutris dosbox kvantum-qt5 htop neofetch firewalld
